export default function Moviescard() {
    return (
      <>
        <div className="z-20">
          <img src="./src/assets/movies/cover.webp" className="h-full" />
          <div class="max-w-md md: absolute top-6 left-28">
            <a href="#"></a>
            <a href="#">
              <img
                src="./src/assets/movies/title.webp"
            ...
            <div class="lg:py-5 md:py-0">
              ...
              <p className="mb-3  text-white md:font-bold md:text-base text-xs flex flex-row">
                2016 &bull; 1h 45m &bull; 4 Languages  &bull;
                <a
                  href="#"
                  class=" w- hidden md:block items-center px-3 py-2 text-sm font-bold ms-2 text-center text-white rounded-lg  dark:bg-gray-600 opacity-60 md:text-sm "
                >
              U
                </a>
              </p>
